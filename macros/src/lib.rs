// TODO manual rewrite – generated by o-1 https://chatgpt.com/c/67dad45d-8e28-8000-82dd-21dc9e9a4cf3
...
impl SdqlValue {
    fn into_token_stream(self) -> proc_macro2::TokenStream {
        match self {
            SdqlValue::Map(pairs) => {
                // Build the HashMap by inserting entries one-by-one,
                // avoiding a huge array literal on the stack.
