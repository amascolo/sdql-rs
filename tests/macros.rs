...
use sdql_runtime::{date, Bool, Date, HashMap, HashSet, Real, Record, VarChar, FALSE, TRUE};
...
fn sdql_static() {
    ...
    assert_eq!(sdql_static!(-1), -1i32);
    assert_eq!(sdql_static!(3.14), Real::new(3.14));
    assert_eq!(sdql_static!(date(20001231)), date!(20001231));
    assert_eq!(
        sdql_static!(<false, true, 1, -1, 3.14, date(20001231)>),
        Record::new((FALSE, TRUE, 1i32, -1i32, Real::new(3.14), date!(20001231),))
    );
    assert_eq!(
