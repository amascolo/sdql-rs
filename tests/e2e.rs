...
fn tpch_q8() {
    ...
    let _expected: TypeQ8 = sdql_static!(include!("tests/results/tpch/SF_0.01/8.sdql"));
...
fn tpch_q13() {
    ...
    let _expected: TypeQ13 = sdql_static!(include!("tests/results/tpch/SF_0.01/13.sdql"));
    // assert_abs_diff_eq!(actual, expected, epsilon = ((0, 0), ()));
}
...
fn tpch_q16() {
    ...
    let _expected: TypeQ16 = sdql_static!(include!("tests/results/tpch/SF_0.01/16.sdql"));
    // assert_abs_diff_eq!(actual, expected, epsilon = (((), (), 0, 0), ()));
}
...
fn tpch_q17() {
    ...
    let _expected: TypeQ17 = sdql_static!(include!("tests/results/tpch/SF_0.01/17.sdql"));
    // assert_abs_diff_eq!(actual, expected, epsilon = 1e-4);
}
...
fn tpch_q20() {
    ...
    let _expected: TypeQ20 = sdql_static!(include!("tests/results/tpch/SF_0.01/20.sdql"));
...
fn tpch_q22() {
    ...
    let _expected: TypeQ22 = sdql_static!(include!("tests/results/tpch/SF_0.01/22.sdql"));
    // assert_abs_diff_eq!(actual, expected, epsilon = ((0, 0, 1e-4), ()));
}
